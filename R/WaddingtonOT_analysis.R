...
atlas_v2_LRP$time <- atlas_v2_LRP$time + 4
...
# Fates to P1 
# Probability for each cell to transition into a given cluster identity at subsequent time points
...
# subset n_cells for each cluster and perform WOT on resulting subset dataset - REPEAT 3 TIMES
for (sub in 1:3){
