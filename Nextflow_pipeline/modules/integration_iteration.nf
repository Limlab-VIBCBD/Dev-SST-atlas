process integration_iteration {

    input:
      tuple path(object), val (cl)
      val tmppath
      val reproducibility

    output:
      tuple path("obj_with_pca_${cl}.RDS"), path("data_use_${cl}.RDS"), path("dgem.kfold_${cl}.RDS"), val(cl)
    ...
    script:
      ...
      saveRDS(obj,'obj_with_pca_${cl}.RDS')
      ...
      saveRDS(data.use,'data_use_${cl}.RDS')
