...
Note: to run the entire chunk, the .csv/.rds files need to be located in the same directory of the Figure_Script.RDM
---
## Packages to install
```{r}
...
supertype <- c("Sst Chodl Gaba_2", "Sst Chodl Gaba_4") 
ggplot(spatial_data, aes(x, y)) + 
  geom_point(colour = "gray90", size = 0.6) +  # Background points
  theme_void() +
  geom_point(data = spatial_data[spatial_data$supertype_label %in% c("Sst Chodl Gaba_2", "Sst Chodl Gaba_4") ,], aes(x, y, colour = supertype_label)) +  
