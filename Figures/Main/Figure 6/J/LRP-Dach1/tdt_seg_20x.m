...
function [RCE_total2 , RCE_total] = tdt_seg_20x(filename, RCE_ch,s)
...
% c1_fgm2 = bwareaopen (c1_fgm, 500);
% c1_fgm = c1_fgm - c1_fgm2; 
[~, bw_ch1] = thresh_tool(Ich1); %image to black and white - binary operation
%%
RCE_total = imerode(bw_ch1, [se(2), se(1)]); 
%figure, imshow(RCE_total); 
%%
%RCE_total = imfill (bw_ch1, 'holes'); 
RCE_total = bwareaopen (RCE_total, 20);
