...
+ kBET Rejection Rate — The kBET test was used to compute the rejection rate, assessing how well the query dataset and Atlas-v0 were mixed in the integrated PCA space. A rejection rate below 50% was set as the acceptance threshold.
